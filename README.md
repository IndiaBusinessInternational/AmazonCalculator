...
- **STEP tier waiver applied automatically** (Basic / Standard / Advanced / Premium)
...
- Easy Ship fee (gross), STEP waiver, and net
...
The calculator uses the following Amazon India rates (effective **16 March 2026**):

**Easy Ship Weight Handling Fee** (₹, pre-GST):

| Zone     | First 500g | First 1kg | Each additional 500g |
|----------|-----------:|----------:|---------------------:|
| Local    | ₹37        | ₹46       | ₹16                  |
| Regional | ₹47        | ₹64       | ₹17                  |
| National | ₹76        | ₹102      | ₹26                  |

> ₹10 reduction applies on weight handling for products priced under ₹300.
...
**STEP Tier Waiver** (₹ off Weight Handling Fee per order):
