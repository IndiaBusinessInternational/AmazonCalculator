...
**Closing Fee** (Easy Ship, ₹ pre-GST, *category-dependent*):

| Selling Price | Typical Fee | Notes |
|---------------|------:|------|
| Up to ₹300    | ₹20 | Standard |
| ₹301 – ₹500   | ₹26 | Standard categories; lower for some |
| ₹501 – ₹1,000 | ₹46 | Standard categories |
| Above ₹1,000  | ₹71 | Standard categories |

> **Closing fees vary by category.** Email order confirmations show that for IBI's product mix, Banana Leaves (₹500) charges only ₹2 in non-shipping fees, Jewelry (₹238) charges ~₹1, while Aluminium kitchenware (₹499) charges ~₹22. The calculator uses standard slabs as a conservative upper bound — your actual closing fee may be lower.
