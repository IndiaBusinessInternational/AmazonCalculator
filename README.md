...
> **All 25 listings match exactly to the rupee.** The fee structure has three flat bands under ₹1,000, then transitions to percentage-based above.
>
> **Category-specific referral rates above ₹1,000** (empirically observed from IBI's listings):
> - Home Improvement (buckets, trowels): ~18.4%
> - Home & Kitchen: ~12.9% – 15.8% (varies by sub-category — heavy items lower)
> - Default: 13%
